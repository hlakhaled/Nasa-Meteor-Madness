...
function AsteroidInfo({ asteroid }) {
  ...
  return (
    <Card className="bg-black/80 border-purple-500 text-white w-full">
      <CardHeader>
        <div className="flex items-center gap-2">
          <AlertTriangle className="h-5 w-5 text-orange-500 flex-shrink-0" />
          <CardTitle className="text-lg truncate">{asteroid.name}</CardTitle>
        </div>
      </CardHeader>
      <CardContent className="space-y-3">
        <div className="grid grid-cols-2 gap-2 text-sm">
          <div className="min-w-0">
            ...
            <span className="ml-2 font-semibold text-purple-300 truncate">
              {asteroid.size}
            </span>
          </div>
          <div className="min-w-0">
        ...
        <div className="flex items-center justify-between gap-2 flex-wrap">
          ...
          <Badge
            className={`text-xs ${threatColor} border-current whitespace-nowrap`}
          >
            {threatLevel} THREAT
          </Badge>
        </div>
        ...
        <div className="text-xs text-gray-300 bg-gray-900/50 p-2 rounded break-words">
          <Info className="h-3 w-3 inline mr-1 flex-shrink-0" />
      ...
      {gameState.use3DView ? (
        <div className="absolute inset-0 pointer-events-auto h-full w-full">
          <Simulation3D
            ...
            deflectionMethod={gameState.deflectionMethod} // 👈 ADD THIS
          />
        </div>
      ) : (
        <div className="absolute inset-0 pointer-events-auto h-full w-full">
    ...
    setGameState((prev) => {
      ...
      if (success) {
        ...
        if (prev.deflectionMethod === "kinetic") {
          ...
          methodMultiplier =
            method.effectiveness[asteroid.composition] *
            (1 + (DART_BETA - 1) * 0.6);
  ...
  return (
    <div className="relative h-screen overflow-hidden text-white flex flex-col md:flex-row">
      ...
      >
        ...
        <div className="w-full md:w-80 lg:w-95 flex-shrink-0 p-2 md:p-4 space-y-4 bg-black/70 backdrop-blur-lg rounded-xl overflow-y-auto z-20 order-1 md:order-none scrollbar-purple">
          ...
          <Card className="bg-black/80 border-purple-500 text-white">
            <CardContent className="p-4">
              ...
              <div className="flex gap-2">
                <Button
                  onClick={() =>
                    setGameState((p) => ({ ...p, use3DView: true }))
                  }
          ...
          <div className="w-[80%] max-w-2xl max-h-lg w-full max-h-screen overflow-auto mx-auto p-4 md:p-5 rounded-xl border border-purple-800 shadow-lg text-white space-y-2 bg-gradient-to-br from-black/90 to-purple-900/20">
            <div className="text-center space-y-2">
              <div className="flex items-center justify-center gap-2 text-purple-400">
                ...
                <h2 className="text-3xl font-bold">
                  PLANETARY DEFENSE BRIEFING
                </h2>
              </div>
              <p className="text-red-400 text-lg font-semibold flex items-center justify-center gap-2">
                <AlertTriangle className="w-5 h-5" /> CRITICAL THREAT DETECTED
              </p>
              <p className="text-gray-300 text-md">
                Asteroid on collision course with Earth. Deflect or face
                extinction.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Card className="bg-blue-900/30 border-blue-600">
                ...
                <CardContent className="text-sm text-gray-200 space-y-1">
                  <ul className="list-disc pl-5">
                    <li className="inter-text">
                      Match method to asteroid type
                    </li>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="bg-gray-800/50 border-gray-700">
                <CardContent>
                  ...
                  <p className="inter-text text-xs text-gray-400">
            ...
            <Button
              ...
              className="w-full h-12 text-xl font-bold bg-red-600 hover:bg-red-700 mt-6 flex items-center justify-center gap-2"
            >
      ...
      {showResult && (
        <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4">
          <Card
            ...
            } bg-black/90 text-white max-w-md w-full mx-4`}
          >
            <CardHeader>
              <CardTitle
            ...
            <CardContent className="space-y-4 text-center ">
              ...
              <div className="flex gap-4 mt-4">
                <Button
                  ...
                  className="flex-1 bg-purple-600 hover:bg-purple-700 text-xl "
                >
